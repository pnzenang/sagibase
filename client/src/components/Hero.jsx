...
const Hero = () => {
  return (
    <div className=' grid lg:grid-cols-2 gap-24 items-center mt-28 mb-40'>
      <div>
        ...
        <p className='mt-10 max-w-xl text-lg leading-8 text-base-content'>
          At SAGI, we mimic the african solidarity, making one family's problem
          the problem of the whole community by putting our effort together
          every time one of our member falls. It is that is the hallmark of the
          African solidarity. making it a little easier for any of us, to face
          up to the adversity of financially taking care of expenses related to
